...
<Border className="my-8" />
  ...
  <Section id="challenge">
    ...
    Develop a platform that desploys a premade template within minutes. This application needs to have multiple services coupled together:
...
Realtor Simplified Saas as a whole is split in 3 different systems. Each of this systems is hosted in their own server and they communicate through apis.
