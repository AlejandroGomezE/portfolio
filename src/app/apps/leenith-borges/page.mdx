...
<Border className="my-8" />
  ...
  <Section id="challenge">
    ...
    Replace and existing website by translating a Figma design to a web application using ReactJS, Bootstrap and Sass for the Frontend, Firebase for the Backend, 
