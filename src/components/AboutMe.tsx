  ...
  return (
    <div className="relative z-10">
      <SectionHeader
        ...
        description={
          <div>
            I&apos;m a <span className="text-about_me_green">software engineer</span> specialized on <span className="text-about_me_green">Web Applications</span>
          </div>
        }
      />
      <Stars id="about-me" />
      <div className="@container">
        <div className="flex flex-col gap-8 mt-24 @lg:flex-row justify-between">
          <div className="max-w-xl flex-auto">
            ...
            <p className="text-base leading-7 text-about_me_green"> Full-stack Enginner</p>
